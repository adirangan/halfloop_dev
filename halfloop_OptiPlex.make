...
# Compiler
CC=gcc
CCFLAGS_dev= -fPIC -w -O2 -mavx -mfma -fopenmp -lgslcblas -lm -I./dir_h -I./dir_c -Wl,-R -Wl,/usr/lib/x86_64-linux-gnu -DSINGLE
...
$(project): $(objects_dev) $(header_dev)
	rm -f $(project)
	gcc -fPIC -w -O2 -mavx -mfma -fopenmp ./dir_c/main_driver.c -o $(project) -L./dir_h -L./dir_c -I./dir_h -I./dir_c -D_MONOLITH -DSINGLE -lgslcblas -lm -Wl,-R -Wl,/usr/lib/x86_64-linux-gnu 

$(project_lib): $(objects_dev) $(header_dev)
	rm -f $(project_lib).so
	gcc -shared -fPIC -w -O2 -mavx -mfma -fopenmp -o $(project_lib).so $(objects_dev) -L./dir_h -L./dir_c -I./dir_h -I./dir_c -D_MONOLITH -DSINGLE -lgslcblas -lm -Wl,-R -Wl,/usr/lib/x86_64-linux-gnu 
